GRANT EXECUTE ON `projekt_bazy_sklep`.* TO 'interfejs'@'localhost' IDENTIFIED BY PASSWORD '*35A0B0F1B8BF3102F473C1F1E6635608AA2DFFFC';
...
GRANT SELECT ON `projekt_bazy_sklep`.`pracownik_uprawnienie` TO 'interfejs'@'localhost';
